...
async function runApp()
{
    ...
    try {
        ...
        connection = await oracledb.getConnection({ user: "ADMIN", password: "zkbu885Um7UtcFt", connectionString: "(description= (retry_count=20)(retry_delay=3)(address=(protocol=tcps)(port=1522)(host=adb.us-sanjose-1.oraclecloud.com))(connect_data=(service_name=ged003edb9e907e_vitalsignsdatabase_high.adb.oraclecloud.com))(security=(ssl_server_dn_match=yes)))" });
